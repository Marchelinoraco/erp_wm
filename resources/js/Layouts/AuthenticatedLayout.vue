...
const navGroups = computed(() => {
    ...
    if (role === 'admin' || role === 'sales') {
        groups.push({ label: 'Penjualan', items: [
            ...
            { label: 'MICE / Event',route: 'tours.index', params: { type: 'mice' },      type: 'mice',      icon: ICON.mice },
            { label: 'Hotel',       route: 'tours.index', params: { type: 'hotel' },     type: 'hotel',     icon: ICON.hotel },
        ]})
